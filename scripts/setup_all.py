...
def main():
    ...
    blockchain_scripts_dir = os.path.join(blockchain_dir, "scripts")
    ...
    run_command([sys.executable, "compile_contract.py"], cwd=blockchain_scripts_dir)

    # 5. Deploy Smart Contract
    print("\n[5/5] Deploying Smart Contract to Ganache...")
    run_command([sys.executable, "deploy_contract.py"], cwd=blockchain_scripts_dir)
